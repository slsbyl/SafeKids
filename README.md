...
|----------|---------------------------|------------------------|--------------------------|-----------------------|---------------------|
| Week 1   | Initialize Project and version control| Splash screen UI      | UI - UX Design           | Build Static UI       | Build Static UI     |
| Week 2   | API and Networking Setup          | View Model            | Dynamic UI               | Dynamic UI            | Dynamic UI          |
| Week 3   | Implement Navigation      |  link sreach screen and detail screen  | Pass Data                | Build Detail Screen   | Unit Testing        |
| Week 4   | unit test         | home screen edit    | Functional Documentation | UI Polish             | UI Polish           |
